...
-- Enable this to save objects

TronConfig.Dev = false

-- Default map configurations so you can be lazy
--    I recommend not touching these values
...
-- Maps configs have these values
--    name: World name
--    position: Starting position (btw, 2 meters above the ground level is ideal otherwise bikes get damaged or flip when spawning)
--    deathPosition: Where players are placed after death (defaults to above the starting position)
--    radius: Starting positions are placed on the edge of this radius (defaults to whatever is set in the TronConfig.Defaults)
--    vehicle: A table with vehicle arguments, this table can contain anything even colors (pls no..)
--    minPlayers: The minimum amount of players for the map, can't be less than 2 defaults to what's set in TronConfig.Defaults
--    maxPlayers: The maximum amount of players for the map, can be any number greater than 2 defaults to what's set in TronConfig.Defaults
--    props: A table of prop arguments, this table can contain anything

TronConfig.Maps = {
	-- {
	-- 	name = "Volcano Rumble",
	-- 	position = Vector3(14125.753906, 335, 14346.990234),
	-- 	vehicles = {
	-- 		{
	-- 			model_id = 11,
	...
	-- 			model_id = 90
	-- 		}
	-- 	} -- P.S. Don't try to add props here, they won't render 50% of the time due to a client issue
	-- },
	{
		name = "Dish",
	...
	-- 	position = Vector3(13064.976562, 256.567261, -3057.425537),
	-- 	radius = 5,
	-- 	maxRadius = 150,
	-- 	maxPlayers = 4,
	-- 	vehicles = { -- ATV
	...
	-- },
	-- {
	-- 	name = "Airport Shake Up",
	-- 	position = Vector3(-6436.765137, 210.981461, -3580.662109),
	-- 	radius = -40,
	-- 	maxRadius = 400,
	-- 	maxPlayers = 8,
	-- 	vehicles = {
